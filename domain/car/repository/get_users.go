...
func (lr carRepository) GetCarListsRepository(ctx context.Context, limit, offset int, sortby, search string, queryRequest shared_model.QueryRequest) (products []model.Car, err error) {
