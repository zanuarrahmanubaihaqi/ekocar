...
func (lr userRepository) BulkInsertCounterRepository(ctx context.Context, limit int) (err error) {
...
func (lr userRepository) GetLastCounterRepository(ctx context.Context) (number string, err error) {
...
func (lr userRepository) GetDocNumberRangeRepository(ctx context.Context) (data model.NumberRange, err error) {
...
func (lr userRepository) GetAndUpdateNumberNextRepository(ctx context.Context, tx *sql.Tx) (number int, err error) {
